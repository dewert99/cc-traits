...
impl<'a, K: Ord, V> OccupiedEntry<'a, BTreeMap<K, V>> for btree_map::OccupiedEntry<'a, K, V> {
...
impl<'a, K: Ord, V> VacantEntry<'a, BTreeMap<K, V>> for btree_map::VacantEntry<'a, K, V> {
